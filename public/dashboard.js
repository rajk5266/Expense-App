...
document.addEventListener('DOMContentLoaded', async function () {
    try {
        const Response = await axios.get('https://spendsmart-nkgi.onrender.com/totalExpenses', tokentosend);
    ...
    async function chart() {
        try {
            const expensePiechart = await axios.get('https://spendsmart-nkgi.onrender.com/expensesCategoryData', tokentosend);
            const incomesPiechart = await axios.get('https://spendsmart-nkgi.onrender.com/incomesCategoryData', tokentosend);
    ...
    async function transaction(){
     try{
      const lastEntries = await axios.get('https://spendsmart-nkgi.onrender.com/lastEntries', tokentosend)
