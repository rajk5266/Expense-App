...
document.addEventListener('DOMContentLoaded', async function () {
    try {
        const Response = await axios.get('http://localhost:8000/user/totalExpenses', tokentosend);
    ...
    async function chart() {
        try {
            const expensePiechart = await axios.get('http://localhost:8000/user/expensesCategoryData', tokentosend);
            const incomesPiechart = await axios.get('http://localhost:8000/user/incomesCategoryData', tokentosend);
    ...
    async function transaction(){
     try{
      const lastEntries = await axios.get('http://localhost:8000/user/lastEntries', tokentosend)
