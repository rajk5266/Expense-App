...
window.addEventListener('DOMContentLoaded', async () => {
    try{
        const reportHistory = await axios.get('https://spendsmart-nkgi.onrender.com/premium/report/history', tokentosend)
...
async function generateReport(reportType, selectedValue) {
    ...
    if (reportType === 'date') {
        ...
        const dailyReport = await axios.post('https://spendsmart-nkgi.onrender.com/premium/report/dailyReport', { Date: selectedValue }, tokentosend)
        ...
        downloadReportButton.onclick = async () => {
            try{
                const downloadReport = await axios.post('https://spendsmart-nkgi.onrender.com/premium/report/dailyReport/download', { Date: selectedValue }, tokentosend)
        ...
        const monthlyReport = await axios.post('https://spendsmart-nkgi.onrender.com/premium/report/monthlyReport', { month: selectedValue }, tokentosend)
        ...
        downloadReportButton.onclick = async () => {
            try{
                const downloadReport = await axios.post('https://spendsmart-nkgi.onrender.com/premium/report/monthlyReport/download', { month: selectedValue }, tokentosend)
                if(downloadReport.status === 200){
                    var a = document.createElement('a');
                    a.href = downloadReport.data.fileURL;
                    console.log(downloadReport.data)
        ...
        const customDateReport = await axios.post('https://spendsmart-nkgi.onrender.com/premium/report/customDate', obj, tokentosend)
        ...
        downloadReportButton.onclick = async () => {
                try{
                    const downloadReport = await axios.post('https://spendsmart-nkgi.onrender.com/premium/report/customDate/download', obj, tokentosend)
                    if(downloadReport.status === 200){
                        var a = document.createElement('a');
                        a.href = downloadReport.data.fileURL;
                        console.log(downloadReport.data)
