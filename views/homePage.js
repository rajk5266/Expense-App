...
document.addEventListener('DOMContentLoaded', async function () {
    try {
        const Response = await axios.get('http://localhost:5000/user/totalExpenses', tokentosend);
    ...
    //     try {
    //         const expensePiechart = await axios.get('http://localhost:5000/user/expensesCategoryData', tokentosend);
    //         const incomesPiechart = await axios.get('http://localhost:5000/user/incomesCategoryData', tokentosend);
    ...
    async function transaction(){
     try{
      const lastEntries = await axios.get('http://localhost:5000/user/lastEntries', tokentosend)
